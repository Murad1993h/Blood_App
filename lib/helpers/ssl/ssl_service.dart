...
class SSLService extends StatefulWidget {
  const SSLService({super.key});

  @override
  _SSLServiceState createState() => _SSLServiceState();
}

class _SSLServiceState extends State<SSLService> {
  ...
  Future<void> sslCommerzGeneralCall() async {
    Sslcommerz sslcommerz = Sslcommerz(
      initializer: SSLCommerzInitialization(
        ...
        sdkType: _radioSelected == SdkType.TESTBOX ? SSLCSdkType.TESTBOX : SSLCSdkType.LIVE,
  ...
  Future<void> sslCommerzCustomizedCall() async {
    ...
    sslcommerz
        .addEMITransactionInitializer(
            sslcemiTransactionInitializer: SSLCEMITransactionInitializer(emi_options: 1, emi_max_list_options: 9, emi_selected_inst: 0))
