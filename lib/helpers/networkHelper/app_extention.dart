...
class BadRequestException extends AppException {
  BadRequestException([String? message, String? url]) : super(message, 'The request was invalid', url);
}

class AuthenticationError extends AppException {
  AuthenticationError([String? message, String? url])
      : super(message, 'The request did not include an authentication token or the authentication token was expired', url);
}

class ServerError extends AppException {
  ServerError([String? message, String? url]) : super(message, 'The request was not completed due to an internal error on the server side.', url);
}
