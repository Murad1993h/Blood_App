...
class AppSpaces {
  ...
  static Padding spaces_height_100 = const Padding(padding: EdgeInsets.only(top: 100));
  static Padding spaces_height_160 = const Padding(padding: EdgeInsets.only(top: 160));
  ...
  static EdgeInsets spaces_all_15 = const EdgeInsets.all(15); //Padding(padding: EdgeInsets.all(15));
  ...
  static EdgeInsets custom_spaces({double? left, double? right, double? bottom, double? top}) =>
